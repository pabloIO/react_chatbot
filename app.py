...
bot = reactbot.Bot('ReactBot', 'reactbot')
...
from controllers import login_ctrl, chat_ctrl, text_analysis_ctrl
...
def get_conversations():
    return chat_ctrl.ChatCtrl.getConversations(db, Response)

@app.route('/conversations/word_cloud')
def get_word_cloud():
    return text_analysis_ctrl.TfIdfCtrl.word_cloud(db, Response)
